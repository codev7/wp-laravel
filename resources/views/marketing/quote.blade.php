...
@section('title')
<title>Get a Guaranteed Price Quote For Your Project from Code My Views</title>
@stop

@section('meta')

<meta name="description" content="You tell us about what you need and when you need it.  We review it and get back to you in an hour with any questions and an estimate." />

<link rel="canonical" href="{{  route('quote') }}" />
@stop
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="how-work clearfix">
						<img src="images/img-46.svg" alt="image description" class="pull-left how-img" >
