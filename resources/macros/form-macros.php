...
\Form::macro('textField', function ($name, $label = null, $value = null, $attributes = array()) {
    ...
    if (isset($attributes['help']))
        $help_block = $attributes['help'];
    else
        $help_block = null;

    return fieldWrapper($name, $element, $label, $help_block);
});
...
\Form::macro('textareaField', function ($name, $label = null, $value = null, $attributes = array(), $help_block = null) {
...
if (!function_exists('fieldWrapper')) {
    function fieldWrapper($field, $element, $label = null, $help_block = null)
    {
        ...
        if ($help_block)
            $out .= '<p class="help-block">' . $help_block . '</p>';
