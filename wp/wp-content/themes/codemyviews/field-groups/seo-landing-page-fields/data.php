<?php 
$group = array (
  'key' => 'group_56225a7d77fc1',
  'title' => 'SEO Landing Page Fields',
  'fields' => 
  array (
    0 => 
    array (
      'key' => 'field_56225a7d7c7eb',
      'label' => 'H1 Title',
      'name' => 'h1_title',
      'type' => 'text',
    ...
    1 => 
    array (
      'key' => 'field_56225a7d7cfcf',
      'label' => 'H2 Title',
      'name' => 'h2_title',
      'type' => 'text',
      'instructions' => 'This is the h2 title on the page.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
    ...
    2 => 
    array (
      'key' => 'field_56225a7d86201',
      'label' => 'Intro Paragraph',
      'name' => 'intro_paragraph',
      'type' => 'wysiwyg',
      'instructions' => 'This is the intro paragraph on the page (top right of the landing page).  Write 2-3 sentences that are related to the content of the landing page.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
    ...
    3 => 
    array (
      'key' => 'field_56225a7d86503',
      'label' => 'Title Tag',
      'name' => 'title_tag',
      'type' => 'text',
      'instructions' => 'This will be the title tag for the page.  This should be limited to 50-60 characters.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
    ...
    4 => 
    array (
      'key' => 'field_56225a7d86637',
      'label' => 'Meta Description',
      'name' => 'meta_description',
      'type' => 'textarea',
      'instructions' => 'This is the meta description for the landing page.  Each landing page should have a unique and descriptive meta description.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
    ...
    5 => 
    array (
      'key' => 'field_56225a7d86763',
      'label' => 'Thumbnail',
      'name' => 'thumbnail',
      'type' => 'image',
      'instructions' => 'This will be a default thumbnail used for the SEO landing page.  If you do not have one, just leave this blank.',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
    ...
    6 => 
    array (
      'key' => 'field_56225a7d8688f',
      'label' => 'Bottom Call to Action Header',
      'name' => 'bottom_call_to_action_header',
      'type' => 'text',
      'instructions' => 'This is the call to action header at the bottom of the landing page.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
      ...
      'default_value' => 'Get a free quote for your PSD to HTML project',
      'placeholder' => '',
      'prepend' => '',
      'append' => '',
      'formatting' => 'html',
    ...
    7 => 
    array (
      'key' => 'field_56225a7d869ba',
      'label' => 'Bottom Call to Action Secondary Text',
      'name' => 'bottom_call_to_action_secondary_text',
      'type' => 'text',
      'instructions' => 'This is the secondary text below the call to action header.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
      ...
      'default_value' => 'All of our quotes are good for 365 days, come back whenever you are ready!',
      'placeholder' => '',
      'prepend' => '',
      'append' => '',
      'formatting' => 'html',
    ...
    8 => 
    array (
      'key' => 'field_56225a7d86b49',
      'label' => 'Call to Action Button Text',
      'name' => 'call_to_action_button_text',
      'type' => 'text',
      'instructions' => 'This is the text on the call to action button',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
      ...
      'default_value' => 'I Want a Free Quote',
      'placeholder' => '',
      'prepend' => '',
      'append' => '',
      'formatting' => 'html',
    ...
    9 => 
    array (
      'key' => 'field_56225a7d86cae',
      'label' => 'Call to Action Destination',
      'name' => 'call_to_action_destination',
      'type' => 'text',
      'instructions' => 'This is the link where the user will be taken when they click the call to action button.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
      ...
      'default_value' => 'https://codemyviews.com/quote',
      'placeholder' => '',
      'prepend' => '',
      'append' => '',
      'formatting' => 'html',
    ...
    10 => 
    array (
      'key' => 'field_56225a7d86df2',
      'label' => 'Call to Action Button Bottom Text',
      'name' => 'call_to_action_button_bottom_text',
      'type' => 'textarea',
      'instructions' => 'This is optional text that appears below the call to action button.',
      'required' => 0,
      'conditional_logic' => 0,
      'wrapper' => 
      array (
      ...
      'default_value' => 'We usually reply in less than an hour <i class="fa fa-smile-o"></i>',
      'placeholder' => '',
      'maxlength' => '',
      'rows' => '',
      'new_lines' => '',
    ...
    array (
      ...
      array (
        ...
        1 => 
        array (
          'key' => 'field_56225a7da1971',
          'label' => 'Icon',
          'name' => 'icon',
          'type' => 'font-awesome',
          'instructions' => 'Select an icon to display on the tab',
          'required' => 1,
          'conditional_logic' => 0,
          'wrapper' => 
          array (
        ...
        2 => 
        array (
          'key' => 'field_56225a7da1b0b',
          'label' => 'Content',
          'name' => 'content',
          'type' => 'wysiwyg',
          'instructions' => 'This is the content of the tab',
          'required' => 1,
          'conditional_logic' => 0,
          'wrapper' => 
          array (
